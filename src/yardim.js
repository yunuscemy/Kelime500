...
(function (global) {
  ...
  var GOVDE = [
    ...
    'değişir: kırmızı → sarı → yeşil → boş. Aynı harf başka tahminlerde de varsa',
    'hepsi birlikte değişir, tek tek boyamak zorunda kalmazsın. Bu sayede',
    'tahminlerin için farklı senaryolar deneyebilirsin. Bir tahmininin içindeki harflerin hiçbiri gizli',
    ...
    '<li>Eğer bir satırdaki notlarını temizlemek istersen, satırın solundaki',
    '<i class="ikon ikon-supurge" role="img" aria-label="süpürge"></i> tuşuna basabilirsin.</li>',
    ...
    '<li>Klavyedeki <i class="ikon ikon-supurge" role="img" aria-label="süpürge"></i> tuşu bütün notlarını temizler.</li>',
